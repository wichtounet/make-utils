...
debug=debug/$(cc_out)
release=release/$(cc_out)
release_debug=release_debug/$(cc_out)
...
DEBUG_FLAGS = -I$(debug)/$(1) $(DEBUG_FLAGS)
RELEASE_FLAGS = -I$(release)/$(1) $(RELEASE_FLAGS)
RELEASE_DEBUG_FLAGS = -I$(release_debug)/$(1) $(RELEASE_DEBUG_FLAGS)
